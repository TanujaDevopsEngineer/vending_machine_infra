...
resource "aws_api_gateway_account" "main" {
  ...
  depends_on          = [aws_api_gateway_rest_api.main, aws_iam_role_policy.api_gateway_logging]
}
...
resource "aws_api_gateway_stage" "prod" {
  ...
  depends_on = [aws_api_gateway_deployment.main, aws_api_gateway_account.main]
}
